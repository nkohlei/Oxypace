...
const Portal = () => {
    ...
    const isVoiceChannelActive = isVoiceChannel && (!isMobileView || mobileChannelOpen);
    ...
    return (
        <div className={`app-wrapper full-height discord-layout ${isVoiceChannelActive ? 'voice-channel-active' : ''}`}>
            <SEO
                title={portal.name}
