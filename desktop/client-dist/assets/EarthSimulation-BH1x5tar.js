import{r,$ as e,a1 as pe,Z as K,aq as de}from"./vendor-CpkDV8T3.js";import{G as me,T as ue,D as ge,A as xe,S as ee,M as be,a as he,b as te,c as ae,d as fe,B as ye,V as ve,e as we}from"./globe-visualization-CJ3D33mH.js";import{d as re}from"./index-B0COkHRm.js";import{N as ke}from"./Navbar-B0IRVkK0.js";import{S as je}from"./SubHeader-Dpjze8UT.js";import{S as Ne}from"./SEO-DCTIT5Yd.js";import"./socket-DZTJH316.js";import"./livekit-Ctw0-e6C.js";import"./lucide-BlbXcz3e.js";import"./UserAvatar-IZ3ETmms.js";/* empty css                  */const ze=r.forwardRef(({portals:y=[],onPortalClick:$,activePortalSearch:z,onGlobeClick:I},q)=>{const o=r.useRef(),k=r.useRef(),x=r.useRef(2.5),h=r.useRef(null),j=r.useRef({x:0,y:0}),g=r.useRef(!1),[w,G]=r.useState({width:window.innerWidth,height:window.innerHeight}),[X,N]=r.useState(!1),U=r.useRef(!1),M=r.useRef(0),R=r.useRef(30),f=r.useCallback(()=>{const t=performance.now();if(t-M.current<1e3/R.current){requestAnimationFrame(f);return}if(M.current=t,!o.current||!g.current)return;const l=o.current.pointOfView(),p=x.current-l.altitude,c=l.altitude<=.8;if(c!==U.current&&(U.current=c,N(c)),Math.abs(p)<1e-4){g.current=!1,h.current=null;return}const n=l.altitude+p*.1;let b=l.lat,d=l.lng;if(h.current&&k.current&&typeof o.current.toGlobeCoords=="function"){const u=o.current.toGlobeCoords(j.current.x,j.current.y);if(u){let E=h.current.lat-u.lat,C=h.current.lng-u.lng;C=((C+180)%360+360)%360-180;const L=.15;b+=E*L,d+=C*L}}b=Math.max(-90,Math.min(90,b)),d=((d+180)%360+360)%360-180,o.current.pointOfView({lat:b,lng:d,altitude:n},0),requestAnimationFrame(f)},[]);r.useImperativeHandle(q,()=>({zoomIn:()=>{x.current=Math.max(.002,x.current*.5),h.current=null,g.current||(g.current=!0,requestAnimationFrame(f))},zoomOut:()=>{x.current=Math.min(4,x.current*2),h.current=null,g.current||(g.current=!0,requestAnimationFrame(f))},resetView:()=>{x.current=2.5,g.current=!1,o.current&&o.current.pointOfView({lat:20,lng:30,altitude:2.5},1500)},flyTo:(t,s,l)=>{const p=l||.012;x.current=p,g.current=!1,o.current&&o.current.pointOfView({lat:t,lng:s,altitude:p},2500)}})),r.useEffect(()=>{const t=()=>{k.current&&G({width:k.current.clientWidth,height:k.current.clientHeight})};if(window.addEventListener("resize",t),setTimeout(t,50),o.current){const s=o.current.controls();s.autoRotate=!0,s.autoRotateSpeed=.3,s.rotateSpeed=.4,s.minDistance=100.2,s.enableZoom=!1,o.current.pointOfView({lat:20,lng:30,altitude:2.5},0)}return()=>{window.removeEventListener("resize",t),o.current&&o.current.scene().traverse(l=>{l.geometry&&l.geometry.dispose(),l.material&&(Array.isArray(l.material)?l.material.forEach(p=>p.dispose()):l.material.dispose())})}},[]);const B=r.useCallback(t=>{if(t.preventDefault(),!o.current)return;o.current.controls().autoRotate=!1;const l=t.deltaY<0?.85:1.15;if(x.current=Math.max(.002,Math.min(4,x.current*l)),k.current&&typeof o.current.toGlobeCoords=="function"){const p=k.current.getBoundingClientRect(),c=t.clientX-p.left,n=t.clientY-p.top;if(Math.hypot(c-j.current.x,n-j.current.y)>2||!g.current||!h.current){const d=o.current.toGlobeCoords(c,n);d?(h.current=d,j.current={x:c,y:n}):h.current=null}}g.current||(g.current=!0,requestAnimationFrame(f))},[f]),S=r.useRef(null),i=r.useRef(null),T=r.useRef(0),O=r.useCallback(t=>{if(o.current){if(o.current.controls().autoRotate=!1,t.touches.length===2){o.current.controls().enabled=!1,h.current=null;const s=t.touches[0].clientX-t.touches[1].clientX,l=t.touches[0].clientY-t.touches[1].clientY;S.current=Math.hypot(s,l),i.current=x.current}else if(t.touches.length===1){const s=Date.now();s-T.current<300&&(x.current=Math.max(.002,x.current*.5),g.current||(g.current=!0,requestAnimationFrame(f))),T.current=s}}},[f]),A=r.useCallback(t=>{if(t.touches.length===2&&o.current&&S.current!==null){t.preventDefault();const s=t.touches[0].clientX-t.touches[1].clientX,l=t.touches[0].clientY-t.touches[1].clientY,p=Math.hypot(s,l),c=S.current/p;x.current=Math.max(.002,Math.min(4,i.current*c)),g.current||(g.current=!0,requestAnimationFrame(f))}},[f]),P=r.useCallback(t=>{t.touches.length<2&&o.current&&(S.current=null,o.current.controls().enabled=!0)},[]);r.useEffect(()=>{const t=k.current;if(t)return t.addEventListener("wheel",B,{passive:!1}),t.addEventListener("touchstart",O,{passive:!1}),t.addEventListener("touchmove",A,{passive:!1}),t.addEventListener("touchend",P),()=>{t.removeEventListener("wheel",B),t.removeEventListener("touchstart",O),t.removeEventListener("touchmove",A),t.removeEventListener("touchend",P)}},[B,O,A,P]);const F=(t,s,l)=>`https://mt1.google.com/vt/lyrs=s&x=${t}&y=${s}&z=${l}&scale=2`;return e.jsxs("div",{ref:k,className:"w-full h-full",onPointerDown:()=>{o.current&&(o.current.controls().autoRotate=!1),h.current=null},children:[e.jsx(me,{ref:o,onGlobeReady:()=>{if(!o.current)return;const t=o.current.scene(),s=o.current.getGlobeRadius?o.current.getGlobeRadius():100,l=new ue;t.traverse(n=>{n.isMesh&&n.material&&!["cloudLayer","volumetricAtmosphere"].includes(n.name)&&(n.material.shininess=10)});const p=t.getObjectByName("globe");if(p&&p.material&&(p.material.emissiveIntensity=0,p.material.emissive&&p.material.emissive.setHex(0),p.material.shininess!==void 0&&(p.material.shininess=5)),!t.getObjectByName("realSun")){const n=new ge(16777215,4.5);n.name="realSun",t.add(n)}if(!t.getObjectByName("zifiriGece")){const n=new xe(14544639,.7);n.name="zifiriGece",t.add(n)}const c=()=>{var b;const n=(b=o.current)==null?void 0:b.camera();if(n){n.children.forEach(u=>{u.isLight&&(u.intensity=0)});const d=t.getObjectByName("realSun");if(d){const u=new ve(-1,.1,.2).normalize();u.applyQuaternion(n.quaternion),u.multiplyScalar(500),d.position.copy(n.position).add(u)}}t.children.forEach(d=>{d.isLight&&d.name!=="realSun"&&d.name!=="zifiriGece"&&(d.intensity=0)}),requestAnimationFrame(c)};if(c(),!t.getObjectByName("cloudLayer")){const n=new ee(s*1.006,64,64),b=l.load("/textures/earth-clouds.png"),d=new be({map:b,transparent:!0,opacity:.8,blending:te,depthWrite:!1,side:he}),u=new ae(n,d);u.name="cloudLayer",t.add(u);const E=()=>{if(u&&o.current){u.rotation.y+=2e-4;const C=o.current.pointOfView().altitude,L=we.clamp((C-.1)*1.5,0,.8);d.opacity=L}requestAnimationFrame(E)};E()}if(!t.getObjectByName("volumetricAtmosphere")){const n=new ee(s*1.18,64,64),b=new fe({vertexShader:`
                            ...
                            `,transparent:!0,blending:te,side:ye,depthWrite:!1}),d=new ae(n,b);d.name="volumetricAtmosphere",t.add(d)}},width:w.width,height:w.height,backgroundColor:"#010206",showAtmosphere:!1,onGlobeClick:I,globeImageUrl:"//unpkg.com/three-globe@2.24.0/example/img/earth-blue-marble.jpg",bumpImageUrl:"//unpkg.com/three-globe@2.24.0/example/img/earth-topology.png",backgroundImageUrl:"//unpkg.com/three-globe@2.24.0/example/img/night-sky.png",globeTileEngineUrl:F,tileLayer:{maxZoom:22,attribution:"Google Satellite-DPI"},htmlElementsData:y,htmlElement:t=>{const s=document.createElement("div");s.className="portal-marker-container";let l="portal-circle";if(z&&z.length>0){const c=z.toLowerCase();t.name.toLowerCase().includes(c)||(t.label||"").toLowerCase().includes(c)?l="portal-circle portal-circle-match":l="portal-circle portal-circle-dimmed"}let p="";if(t.avatar){const c=t.avatar;let n=c;if(c.includes("%3A")||c.includes("%2F"))try{n=decodeURIComponent(c),(n.includes("%3A")||n.includes("%2F"))&&(n=decodeURIComponent(n))}catch{}p=re(n)}return s.innerHTML=`
                        <div class="${l}" data-name="${t.name[0].toUpperCase()}">
                            ${p?`<img src="${p}" alt="${t.name}" onerror="this.onerror=null;this.src='/assets/default-avatar.png';" />`:`<span class="portal-letter">${t.name[0].toUpperCase()}</span>`}
                        </div>
                        <div class="portal-hover-label">${t.name}</div>
                    `,s.style.position="relative",s.style.cursor="pointer",s.onclick=c=>{c.stopPropagation(),$(t)},s.onpointerdown=c=>{c.stopPropagation()},s},htmlLat:t=>t.lat,htmlLng:t=>t.lng,htmlAltitude:0}),e.jsx("style",{children:`
