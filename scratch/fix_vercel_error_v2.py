...
def fix_file(file_path, map_var):
    ...
    for i, line in enumerate(lines):
        ...
        if in_map:
            ...
            # Check for /> or </article> followed by map end
            # We must be careful not to match nested tags
            if (('/>' in line and '<PostCard' in line) or '</article>' in line):
...
# First revert files to clean state
os.system(r'git checkout d8690bd client/src/pages/Portal.jsx client/src/pages/Saved.jsx client/src/pages/Profile.jsx')
